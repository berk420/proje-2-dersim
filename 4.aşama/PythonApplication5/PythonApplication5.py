...
soru = input("sorunu sor:")# girilen string ifadeyi google da aratıyor
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------
nezamanakarsilik=[tarihleriarasında,tarihinde,saatlerinde,saatleriarasında,kadardevamedecek]
