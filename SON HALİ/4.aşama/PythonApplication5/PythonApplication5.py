...
def getvalue():
    ...
    def main(name):
        ...
        for x in nezamanakarsilik:
            ...
            try:
                ...
                adet=0
                while(adet != 1):#ANAHTAR KELİMEDEN SOLA DOĞRU 1.NOKTAYA kadar
                    print("--")
                    if(text[kontrol] =="."):
                ...
                while(adett != 2):#ANAHTAR KELİMEDEN SAĞA DOĞRU 2.NOKTAYA kadar
                    print("--")
                    if(text[kontrol] =="."):
                        print("ifade noktaya eşit")
                        adett+=1
    ...
    #return '<h1> asd, {}</h1>' .format(txt) #burada yeni sayfa açmak yerine aynı sayfada veriyi gösteriyor
